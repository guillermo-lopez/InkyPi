...
class TickTickAuth:
    ...
    def save_tokens(self, access_token, refresh_token=None):
        ...
        print("New TickTick access token saved")
...
def authenticate():
    ...
    if tokens:
        ...
        if new_access_token:
            print("Successfully refreshed TickTick access token!")
            return auth
    ...
    # Wait for callback
    print("Waiting for TickTick authentication...")
    ...
    print("TickTick authentication failed!")
    return None
